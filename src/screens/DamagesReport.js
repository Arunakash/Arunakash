...
const DamagesRprt = (props) => {
  ...
  const listData = [
    { name: "Arun", count: 20 },
    { name: "Kumar", count: 10 },
    { name: "Ramesh", count: 15 },
    { name: "Prabhu", count: 23 },
    { name: "Logesh", count: 20 },
    { name: "Kanan", count: 20 },
    { name: "Karun Kumar", count: 2 },
    { name: "Muhamad sahib", count: 12 },
    { name: "Janani", count: 21 },
    { name: "Raghavi", count: 13 },
  ];
        ...
        <View style={{ paddingTop: 20 }}>
          ...
          >
            <View style={styles.dateTxtHldr}>
              <Text>
                <Text style={{ color: COLORS.primary }}>From:</Text> 20 Apr,
                2020
              </Text>
            </View>
            <View style={styles.dateTxtHldr}>
              <Text>
                <Text style={{ color: COLORS.primary }}>To:</Text> 30 Apr, 2020
              </Text>
            </View>
          </View>
          <View
          ...
          >
            <Ionicons
              ...
              size={20}
              color={
                isSearchBarFocused ? COLORS.primary : COLORS.sideDrawerIconClr
              }
